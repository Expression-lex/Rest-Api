...
class HelloViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        serialixer = self.serializer_class(data=request.data)

        if serialixer.is_valid():
            name = serialixer.validated_data.get('name')
            message = f'Hello {name}!'
            return Response({'message': message})
    ...
    def retrieve(self, request, pk=None):
        """Handling get an object by its ID"""
...
class userProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    queryset = models.profileFieldItem.objects.all()
    permission_classes =(
        permissions.UpdateFeedClass,
